    ...
    {squawk?.id && squawk.author.username === username ? <div key={`${squawk.id}`}>
      ...
      <div className="squawk-icons">
            {squawk.id && squawk?.parrots.find((person) => person.userId === user.id) ? (
              ...
              >
                <svg className="parroted-icon" viewBox="0 0 25 25" style={{width: "24px"}}>
              <g>
              ...
              >
                <svg className="not-parroted-icon" viewBox="0 0 25 25" style={{width: "24px"}}>
              <g>
            ...
            {squawk.id && squawk?.likes.find((person) => person.userId === user.id) ? (
              ...
              >
                <svg className="liked-icon" viewBox="0 0 25 25" style={{width: "24px"}}>
              <g>
              ...
              >
                <svg className="not-liked-icon" viewBox="0 0 25 25" style={{width: "24px"}}>
              <g>
