    ...
    <>
      <div className="sidenav">
        <div>
          {token && (
            <div
              ...
              className={`sidebar-option ${
                activeNav === "Home" ? "active-nav-option" : " "
              }`}
            >
          ...
          <div
            className={`sidebar-option ${
              activeNav === "Explore" ? "active-nav-option" : " "
            }`}
            onClick={() => navigate("/")}
          >
            <svg className="sidebar-pic" viewBox="0 0 24 24">
          ...
          {token && (
            <div
              className={`sidebar-option ${
                activeNav === "Messages" ? "active-nav-option" : " "
              }`}
          ...
          {user.username && (
            <div
              ...
              className={`sidebar-option ${
                activeNav === "Profile" ? "active-nav-option" : " "
              }`}
            >
              <svg className="sidebar-pic" viewBox="0 0 24 24">
                <g>
          ...
          {token ? (
            <>
              ...
              <div
                onClick={() => {
                  document.getElementById("popup-squawk-form").style.display =
                    "flex";
                  document.getElementById("background").style.display = "flex";
                }}
                className="squawk-button side-squawk-button"
              >
                Squawk
              </div>
            </>
